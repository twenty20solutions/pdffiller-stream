...
describe("pdfFiller Tests", function () {
    describe("fillForm()", function () {
        ...
        it("should use toFile to create a completely filled PDF that is read-only", function () {
            return pdfFiller
                ...
                .then(function () {
                    return pdfFiller
                        .generateFieldJson(dest2PDF, null)
        ...
        it("should create an unflattened PDF with unfilled fields remaining", function () {
            ...
            return pdfFiller
                .fillFormWithFlatten(source3PDF, _data2, false)
                .toFile(dest3PDF)
                .then(function () {
                    return pdfFiller
                        .generateFieldJson(dest3PDF, null)
                        .then(function (fdfData) {
        ...
        it("should handle expanded utf characters and diacritics", function () {
            ...
            return pdfFiller
                .fillFormWithFlatten(source4PDF, diacriticsData, false)
                .toFile(dest4PDF)
                .then(function () {
                    return pdfFiller
                        .generateFieldJson(dest4PDF, null)
                        .then(function (fdfData) {
                            fdfData.length.should.not.equal(0);
                        });
                });
    ...
    describe("generateFieldJson()", function () {
        ...
        it("should generate form field JSON as expected", function () {
            return pdfFiller
                .generateFieldJson(source2PDF, null)
                .then(function (form_fields) {
        ...
        it("should generate another form field JSON with no errors", function () {
            return pdfFiller
                .generateFieldJson(source1PDF, null)
                .then(function (form_fields) {
    ...
    describe("generateFDFTemplate()", function () {
        ...
        it("should generate a FDF Template as expected", function () {
            return pdfFiller
                .generateFDFTemplate(source2PDF, null)
                .then(function (fdfTemplate) {
        ...
        it("should generate another FDF Template with no errors", function () {
            return pdfFiller
                .generateFDFTemplate(source1PDF, null)
                .then(function (fdfTemplate) {
